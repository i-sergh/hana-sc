...
def call_create_connect(request:Request, **kwargs):
    ...
    url = f'{HOST}data/create-connection?prjct_name={kwargs["prjct_name"]}&name={kwargs["name"]}&requirements={kwargs["requirements"]}&driver={kwargs["driver"]}&is_target={kwargs["is_target"]}&\
    &host={kwargs["host"]}&port={kwargs["port"]}&db_name={kwargs["db_name"]}&db_schema={kwargs["db_schema"]}&user={kwargs["user"]}&pwd={kwargs["pwd"]}&api_key={kwargs["api_key"]}' 
